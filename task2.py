...
def main():
    ...
    # Calculate the quality ratio for 'Food & Drink' section content (TF-IDF)
    start_time = time()
    ...
    print(
        f"TF-IDF quality ratio for 'Food and Drink': {quality_ratio_tfidf:.3f} (in {time() - start_time:.4f} seconds)"
    )

    # Calculate the quality ratio for 'Food & Drink' section content (LDA)
    start_time = time()
    ...
    print(
        f"LDA quality ratio for 'Food and Drink': {quality_ratio_lda:.3f} (in {time() - start_time:.4f} seconds)"
    )
